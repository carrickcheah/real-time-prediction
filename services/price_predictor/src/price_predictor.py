...
from src.utils import (
    timestamp_ms_to_human_readable_utc,
    get_git_commit_hash,
)
...
class PricePredictor:
    ...
    def from_model_registry(
        ...
        # # TODO: remove this after debugging
        # upper_threshold = float(experiment.get_parameters_summary('upper_threshold')['valueCurrent'])
        # lower_threshold = float(experiment.get_parameters_summary('lower_threshold')['valueCurrent'])
    ...
    def predict(self) -> PricePrediction:
        ...
        # TODO: remove this after debugging
        # use the predicted direction and the self.upper
        ...
        # add a field in the metadata with the git commit hash
        metadata = {
